...
function addQuestion(T,arr){
    ...
    for(var i=0;i<arr.length;i++) {
        var html =
            ...
            '</td>' +
            '<td style="width:5%" class="text-center">--分</td>' +
            '<td style="padding-left:30px;">';

        var op = '';
        for (var j = 0; j < arr[i].options.length; j++) {
            op += '<div class="radio m-b-15">' +
                '<label>' +
...
function addQuestions(){
    addQuestion('daily_lifeT',daily_life_question);
    addQuestion('mental_stateT',mental_state);
    addQuestion('perceivedT',perceived);
    addQuestion('social_participationT',social_participation);
}
