function SelCity(obj,e) {
    var ths = obj;
    var dal = '<div class="_citys"><span title="关闭" id="cColse" >×</span>' +
        '<ul id="_citysheng" class="_citys0"><li class="citySel">省份</li><li>城市</li><li>区县</li><li>街道社区</li></ul>' +
    ...
    $("#_citys0 a").click(function () {
        ...
        $("#_citys1 a").click(function () {
            ...
            $("#_citys2 a").click(function () {
                ...
                var bc = $("#hcity").val();
                var bp = $("#hproper").val();
                var ba=$(this).data("name");
                ths.value = bc + "→" + bp + "→" + $(this).data("name");

               /* $("#city").parent().addClass("fg-toggled");*/
              /*  Iput.colse();*/
              debugger;
                var stre= getStreet($(this));
                $("#_citys3 a").remove();
                $("#_citys3").append(stre);
                $("._citys1").hide();
                $("._citys1:eq(3)").show();
