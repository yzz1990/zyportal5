...
var config = {
    ...
    // 默认菜单配置
    menus: ['head', 'bold', 'italic', 'underline', 'strikeThrough', 'foreColor', 'backColor', 'link', 'list', 'justify', 'quote',  'image', 'table', 'video', 'code', 'undo', 'redo','upload'],
...
function Upload(editor) {
    this.editor = editor;
    this.$elem = $('<div class="w-e-menu"><i class="w-e-icon-upload2"><i/></div>');
    this.type = 'panel';
...
MenuConstructors.upload = Upload;
