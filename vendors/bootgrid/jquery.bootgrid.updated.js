    ...
    */
    ...
    Grid.defaults = {
        ...
        css: {
            ...
            right: "text-right",
            search: "search form-group1", // must be a unique class name or constellation of class names within the header and footer
        ...
        labels: {
            all: "全部",
            infos: "显示第 {{ctx.start}} 到 {{ctx.end}} 条记录，总共 {{ctx.total}} 条记录",
            loading: "加载中，请稍后...",
            noResults: "没有找到匹配项！",
            refresh: "Refresh",
            search: "Search"
